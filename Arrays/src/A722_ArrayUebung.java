...
public class A722_ArrayUebung {
    public static void main(String args[]) {
        ...
        System.out.println("Wert an Position 89: " + zahlen[88]);

        // 6. Ändern Sie den Wert des Arrayelements mit dem Index 49 zu 1060.
        zahlen[49] = 1060;

        // Außerdem ändern Sie den Wert an der ersten und der letzte Stelle des Arrays
        // zu 2023.
        zahlen[0] = 2023;
        zahlen[zahlen.length - 1] = 2023;

        // 7. Erneutes Ausgeben des Arrayinhalts. Darstellung: Index und zugehöriger
        // Inhalt (z.B. Index 6 - Inhalt: 7)
        for (int i = 0; i < zahlen.length; i++) {
            System.out.println("Index " + i + " - Inhalt: " + zahlen[i]);
        }
        ...
        System.out.println("Durchschnitt aller Arrayelemente: " + durchschnitt);
